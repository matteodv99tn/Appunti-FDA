...
\section{Studio del legame ingresso-uscita}
	...
	\subsection{Risposta alla sinusoide: analisi nel dominio della frequenza}
		...
		\begin{figure}[bht]
			\centering
			\begin{subfigure}{0.48\linewidth}
				\centering \includegraphics[width=6cm]{bode} \caption{}
			\end{subfigure}
			\begin{subfigure}{0.48\linewidth}
				\centering \includegraphics[width=5.5cm]{nyquist} \caption{}
			\end{subfigure}
	...
	\subsection{Diagrammi di Bode}
		...
		Considerando per semplicità una funzione di trasferimento ad un solo polo (ma tale effetto vale anche in presenza di un solo zero), si osserva (figura \ref{polo-realvsasint}) che per pulsazioni $\omega$ che sono \textit{distanti} (all'incirca dopo una decade) dalla pulsazione naturale $\omega_\textrm{polo}$ associata al polo allora il comportamento reale è ben approssimato dal diagramma asintotico, tuttavia nell'intorno del polo il comportamento risulta essere deviato. In particolare l'errore massimo si ha in corrispondenza della pulsazione $\omega_\textrm{polo}$ con un errore pari a $3dB$.
		
		\figura{7}{1}{polo-realvsasint}{diagramma asintotico (in nero)  e reale (in arancione) di una funzione di trasferimento ad un solo polo.}{polo-realvsasint} 
		...
		\figura{7}{1}{polo-complesso-diag}{diagramma asintotico (in nero)  e reale (in rosso) di una funzione di trasferimento a poli complessi coniugati al variare dello smorzamento $\xi$.}{polo-complesso-diag} 
		\begin{concetto}
		...
		\begin{figure}[bht]
			\centering
			\includegraphics[width=13cm]{diag-fase}
	...
	\subsection{Classificazione dei sistemi dinamici tramite i diagrammi di Bode}
		...
		\begin{figure}[bht]
			...
			\begin{subfigure}{0.48\linewidth}
				\centering 
				\includegraphics[width=5cm]{passa-basso} \caption{}
			\end{subfigure}
			\begin{subfigure}{0.48\linewidth}
				\centering 
				\includegraphics[width=5cm]{passa-basso-risposta} \caption{}
			\end{subfigure}
		...
		\begin{figure}[bht]
			...
			\begin{subfigure}{0.48\linewidth}
				\centering 
				\includegraphics[width=5cm]{passa-alto} \caption{}
			\end{subfigure}
			\begin{subfigure}{0.48\linewidth}
				\centering 
				\includegraphics[width=5cm]{passa-alto-risposta} \caption{}
			\end{subfigure}
		...
		\begin{esempio}{: risposta allo scalino di un sistema a ritardo di tempo}
			...
			\begin{center}
				\includegraphics[width=4cm]{ritardo-a}
			\end{center}
			...
			\begin{center}
				\includegraphics[width=4cm]{ritardo-b}
			\end{center}
		\end{esempio}
